...
public class UnstableClass {
    ...
    public static int unstableMethod1(int x, int y) {
        if (x > 0) {
            return 10;
        }
    ...
    public static int unstableMethod2(int x, int y) {
        if (x > 0) {
            return 10; // First branch, no division by zero
        } else if (x < 0) {
            return 20;
        }
        return 100 / y;
    ...
    public static int unstableMethod3(int x, int y) {
        if (x > 0) {
            return 5;
        }
        return 10 / y;
